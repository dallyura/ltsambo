...
class PostForm(forms.ModelForm):
    class Meta:
        model = Post
        fields = ('category', 'Panel_name', 'Site_name', 'Operator_name','Depth')

        widgets = {
            'category': forms.Select(choices=choice_list, attrs={'class': 'form-control'}),
            'Panel_name' : forms.TextInput(attrs={'class':'form-control'}),
            'Site_name': forms.Select(attrs={'class': 'form-control'}),
